...
Welcome to this public repository dedicated to optimizing, automating, and integrating **HyperHDR** on **CachyOS** (or any Arch Linux-based distribution). 
...
* **KDE Plasma Launcher Integration:** Adds HyperHDR to your desktop applications menu, bypassing interactive execution prompts.

### 📸 Visual Reference
Here is the HyperHDR dashboard showing successful PipeWire screen capture and active LED streaming under Wayland:
![HyperHDR Status and Components](./images/hyperhdr_status.png)
...
#### 1. Atajo e Integración Estética en KDE Plasma:
![KDE Menu Editor Setup](./images/kde_shortcut.png)

#### 2. Configuración del Puerto de Salida (Hardware LED):
![HyperHDR Hardware Port Configuration](./images/hyperhdr_hardware.png)
